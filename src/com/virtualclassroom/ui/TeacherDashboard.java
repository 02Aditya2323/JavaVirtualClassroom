...
import com.virtualclassroom.ui.teacher.*;
...
public class TeacherDashboard extends JFrame {
    ...
    private void createSidebar() {
        ...
        sidebarPanel.add(createMenuItem("✓ Attendance", () -> showAttendancePanel()));
    ...
    private void showHomePanel() {
        ...
        JLabel feature1 = new JLabel("•  Manage Lectures: Create, view, and schedule your classes.");
        ...
        JLabel feature2 = new JLabel("•  Track Attendance: Take and review student attendance.");
        ...
        JLabel feature3 = new JLabel("•  Post Assignments: Create new assignments and manage submissions.");
    ...
    private void showLecturesPanel() {
        contentPanel.removeAll();
        contentPanel.add(new ViewLecturesPanel(teacher));
        contentPanel.revalidate();
        contentPanel.repaint();
    }
    ...
    private void showAttendancePanel() {
        contentPanel.removeAll();
        contentPanel.add(new AttendanceReportPanel(teacher));
        contentPanel.revalidate();
        contentPanel.repaint();
    }
    ...
    private void showAssignmentsPanel() {
        contentPanel.removeAll();
        contentPanel.add(new ManageAssignmentsPanel(teacher));
        contentPanel.revalidate();
        contentPanel.repaint();
    }
